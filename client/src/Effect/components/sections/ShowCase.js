...
import img11 from "../assets/Nfts/principal.png";
      ...
      <div className="showc">
        <Section>
          ...
          <Row direction="none" ref={RowRef1}>
            ...
            <NftItem img={img4} name="Mst Diya Islam" passRef={RowRef1} />
            <NftItem img={img4} name="Mst Tuli Khatun" passRef={RowRef1} />
          </Row>
          <Row direction="reverse" ref={RowRef2}>
            <NftItem img={img10} name="Md Tarilul Islam" passRef={RowRef2} />
            <NftItem img={img9} name="Md Tahera Khatun" passRef={RowRef2} />
            <NftItem img={img3} name="Md Sariful Islam" passRef={RowRef2} />
            <NftItem img={img4} name="Mst Sharmin Sultana" passRef={RowRef2} />
            <NftItem img={img8} name="Md Harun Islam" passRef={RowRef2} />
            <NftItem img={img7} name="Md Mahub Islam" passRef={RowRef2} />
          </Row>
        </Section>
      </div>
    </>
